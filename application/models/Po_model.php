...
class Po_model extends CI_Model
{
    ...
    public function getPoMaster($idd)
    {

        $query = "SELECT a.kd_po,
                        to_char(a.po_date,'dd-mm-yyyy') as po_date,
                        a.po_number,
                        a.kd_rekanan,
                        a.rev_number,
                        a.ship_to,
                        ...
                        a.kd_del_place,
                        a.quotation_reff,
                        to_char(a.dt_delivery,'dd-mm-yyyy') as dt_delivery,
                        a.dt_quotation,
                        a.payment_desc,
                        a.sub_total,
                        a.vat_str,
    ...
    public function savePo()
    {
       ...
       // $rNo = $this->db->get("purchasing.fn_gen_po_number('" . $vmm . "','" . $vyy . "') as new_no_trans")->row_array();
        $rNo = $this->db->get("purchasing.fn_gen_po_number('" . $datmaster['id_cc_project'] . "','" . $vyy . "') as new_no_trans")->row_array();
        ...
        for ($x = 0; $x <= $Count - 1; $x++) {
            ...
            if (($datdetail[$x]['kd_po_detail']) == '0') {
                ...
                $sQL = "UPDATE purchasing.po_details SET 
                            ...
                            requisition_no = '" . $datdetail[$x]['requisition_no'] . "',
