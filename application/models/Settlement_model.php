...
class Settlement_model extends CI_Model
{
    ...
    public function saveSettlement()
    {
        ...
        $nokasbon = "'" . $datmaster['no_kasbon'] . "'";
        //$dtkasbon = "'" . $datmaster['dt_kasbon'] . "'";
        $ca_value = $datmaster['total_kasbon'];
        $selisih = $datmaster['lebih_kurang'];
        $kasbon = $this->db->get_where('accfin.kasbon', ['no_kasbon' => $datmaster['no_kasbon']])->row_array();
        ...
        $qrM = "INSERT INTO accfin.settlement (
         ...
         VALUES (
          ...
          '1', " . $datmaster['total'] . "," . $nokasbon . ",to_timestamp('" . $datmaster['dt_kasbon'] . "','dd-mm-yyyy'), " . $ca_value . ",
    ...
    public function editSettlement()
    {
        ...
        $qrM = "UPDATE accfin.settlement SET
                ...
                kurs = " . $datmaster['kurs'] . ",
                no_kasbon = " . $nokasbon . ",
                dt_kasbon = to_timestamp('" . $datmaster['dt_kasbon'] . "','dd/mm/yyyy'),
