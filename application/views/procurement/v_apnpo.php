...
<div id="content" class="content">
    ...
    <!-- Modal -->
    <br>
    <div id="dlg" class="easyui-panel" title="--" style="width:100%;height:600px;padding:10px;" data-options="iconCls:'icon-save',closable:true,
                ...
                <div class="col-md-4">
                    <div class="row">
                        <div class="row">
                            ...
                            <div class="col">
                                <input id="po_balance" name="po_balance" class="easyui-numberbox" data-options="precision:2,groupSeparator:','" style="width:150px;text-align: right;height: 30px" />
                            </div>
                            <div class="col"></div>
                        </div>
                    </div>
    ...
    <div id="wi" class="easyui-window" title="Item Data" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:650px;height:500px;padding:10px;">
        ...
        <script type="text/javascript">
            ...
            function fect_item_data(irow) {
                ...
                $('#dgItem').datagrid({
                    url: "<?= base_url(); ?>procurement/Ap/fetchItem"
                });
                ...
                $('#dgItem').datagrid({
                    onDblClickRow: function() {
                        ...
                        if (row) {
                            ...
                            myAppendGrid.setCtrlValue("descriptions", irow, row.nama_item);
...
<script type="text/javascript">
    ...
    function newData() {
        $("#dlg").panel('setTitle', 'New Account Payable [AP] Non PO');
        $('#dlg').panel('open');
        //   $('#fm').form('clear');
    ...
    function editData() {
        ...
        if (row) {
            ...
            $("#dlg").panel('setTitle', 'Update Account Payable [AP] Non PO');
            $('#dlg').panel('open');
            //  $('#fm').form('load', row);
    ...
    function saveDatax() {
        ...
        master.push({
            ...
            total_mrir: parseFloat(po_balance || 0),
    ...
    function reTotalGrid() {
        ...
        $('#po_balance').numberbox('setValue', xtotal);
    }
