        ...
        <table id="dgMain" class="easyui-datagrid" style="width:100%;height:420px;;" url="<?= base_url(); ?>accfin/Payment/getPayment/<?= $notrans; ?>" singleSelect="true" rownumbers="true" pagination="true" toolbar="#toolbarFilter">
            <thead>
                <tr>
                    ...
                    <th field="no_payment" width="150">Cash Receipt #</th>
                    <th field="dt_payment" width="80">Date</th>
                    <th field="nama_rekanan" width="150" align="left">Employee/Customer</th>
...
<script type="text/javascript">
    ...
    function newData() {
        $("#dlg").panel('setTitle', 'New Cash Receipt');
        $('#dlg').panel('open');
        $('#fm').form('clear');
    ...
    function editData() {
        ...
        if (row) {
            ...
            $("#dlg").panel('setTitle', 'Update Cash Receipt');
            $('#dlg').panel('open');
            //  $('#fm').form('load', row);
