...
} elseif (empty($this->session->userdata("br"))) {
    redirect(base_url('accfin/Payment'), 'refresh');
} else {
    $datax = $this->session->userdata('br');
}
?>
...
<body>
    ...
    <table style="width: auto;" cellspacing="5px" cellpadding="5px" border="0">
        <tr>
            ...
            <td><input id="no_payment" class="easyui-textbox" label="Bank Receipt #:" labelPosition="top" readonly="true" style="width:150px;"></td>
            ...
            <td><input id="bank" class="easyui-textbox" label="Bank Origin:" labelPosition="top" required="true" style="width:200px;"></td>
    ...
    <div>
        <!-- div detail -->
        <table id="dg" class="easyui-datagrid" title="Bank Disbursement Detail" style="width:85%;height:auto" data-options="
                iconCls: 'icon-edit',
                singleSelect: true,
				toolbar: '#tb',
                rownumbers: true,
    ...
    <script type="text/javascript">
        ...
        function saveDatax() {
            ...
            if (dt_payment == '') {
                ...
                $.messager.alert('Warning', 'Receipt From must have value', 'warning');
                return false;
            } else if (remarks == '') {
            ...
            $.ajax({
                ...
                success: function(data) {
                    window.open('<?= base_url(); ?>accfin/Payment/Index/Br', '_self');
                }
            });
        }
