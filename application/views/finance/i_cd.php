...
} elseif (empty($this->session->userdata("cd"))) {
    redirect(base_url('accfin/Payment'), 'refresh');
} else {
    $datax = $this->session->userdata('cd');
}
?>
...
<body>
    ...
    <table style="width: auto;" cellspacing="5px" cellpadding="5px" border="0">
        <tr>
            ...
            <td><input id="no_payment" class="easyui-textbox" label="Cash Disbursement #:" labelPosition="top" readonly="true" style="width:150px;"></td>
    ...
    <div>
        <!-- div detail -->
        <table id="dg" class="easyui-datagrid" title="Cash Disbursement Detail" style="width:85%;height:auto" data-options="
                iconCls: 'icon-edit',
                singleSelect: true,
				toolbar: '#tb',
                rownumbers: true,
    ...
    <script type="text/javascript">
        ...
        function saveDatax() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    window.open('<?= base_url(); ?>accfin/Payment/Index/Cd', '_self');
                }
            });
        }
