...
} elseif (empty($this->session->userdata("bd"))) {
    redirect(base_url('accfin/Payment'), 'refresh');
} else {
    $datax = $this->session->userdata('bd');
}
?>
...
<body>
    ...
    <table style="width: auto;" cellspacing="5px" cellpadding="5px" border="0">
        <tr>
            ...
            <td><input id="no_payment" class="easyui-textbox" label="Bank Disbursement #:" labelPosition="top" readonly="true" style="width:150px;"></td>
            <td><input id="kd_rekanan" class="easyui-combogrid" label="Paid To:" labelPosition="top" required="true" style="width:250px;"></td>
            <td><input id="no_cek_bg_tt" class="easyui-textbox" label="Cek/BG/TT #:" labelPosition="top" required="true" style="width:150px;"></td>
            <td><input id="bank" class="easyui-textbox" label="Bank Destination:" labelPosition="top" required="true" style="width:200px;"></td>
            <td rowspan="2"><input id="remarks" class="easyui-textbox" label="Remarks:" labelPosition="top" required="true" multiline="true" style="width:300px;height:100px"></td>
        </tr>
        ...
        <tr>
            ...
            <td><input id="id_rek_gl" class="easyui-combogrid" label="Account  [Cr]:" labelPosition="top" required="true" style="width:250px;"></td>
            <td><input id="jns_ttbg" class="easyui-combobox" label="Transaction type:" labelPosition="top" required="true" style="width:150px;" data-options="
                valueField: 'label',
                textField: 'value',
                data: [{
                label: 'TT',
            ...
            <td><input id="an" class="easyui-textbox" label="Acc Name Destination:" labelPosition="top" required="true" style="width:200px;"></td>
        </tr>
    ...
    <div>
        <!-- div detail -->
        <table id="dg" class="easyui-datagrid" title="Bank Receipt Detail" style="width:85%;height:auto" data-options="
                iconCls: 'icon-edit',
                singleSelect: true,
				toolbar: '#tb',
                rownumbers: true,
        ...
        <div id="tb" style="height:auto">
            ...
            <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-sum',plain:true" onclick="pettycash()">Petty Cash Replenishment</a>
        </div>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            $('#id_rek_gl').combogrid({
                panelWidth: 400,
                url: '<?= base_url()  ?>accfin/Payment/getCoaMaster/BANK',
                idField: 'id_rek_gl',
        ...
        function fetchMasterData(idx) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#an').textbox('setValue', data[0]['an']);
                    $('#bank').textbox('setValue', data[0]['bank']);
                    $('#no_cek_bg_tt').textbox('setValue', data[0]['no_cek_bg_tt']);
                    $('#jns_ttbg').combobox('setValue', data[0]['jns_ttbg']);
        ...
        function saveDatax() {
            ...
            var an = $('#an').textbox('getValue');
            var bank = $('#bank').textbox('getValue');
            var no_cek_bg_tt = $('#no_cek_bg_tt').textbox('getValue');
            var jns_ttbg = $('#jns_ttbg').combobox('getValue');
            ...
            if (dt_payment == '') {
                ...
                $.messager.alert('Warning', 'Account[Cr] must have value', 'warning');
                return false;
            } else if (kd_rekanan == '') {
                $.messager.alert('Warning', 'Paid To must have value', 'warning');
                return false;
            } else if (remarks == '') {
            ...
            $.ajax({
                ...
                success: function(data) {
                    window.open('<?= base_url(); ?>accfin/Payment/Index/Bd', '_self');
                }
            });
        }
        ...
        function pettycash() {
            ...
            var n3 = $(editors[3].target);
            var n4 = $(editors[4].target);
            n0.textbox('setValue', 'PC2006001');
            n1.textbox('setValue', 'Pengisian Kas Kecil/PettyCash');
            n2.textbox('setValue', '100');
            n3.textbox('setValue', '1051');
        };
    </script>
