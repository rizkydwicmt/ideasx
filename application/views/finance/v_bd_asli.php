        ...
        <table id="dgMain" class="easyui-datagrid" style="width:100%;height:420px;;" url="<?= base_url(); ?>accfin/Payment/getPayment/<?= $notrans; ?>" singleSelect="true" rownumbers="true" pagination="true" toolbar="#toolbarFilter">
            <thead>
                <tr>
                    ...
                    <th field="no_payment" width="150">Bank Disbursement #</th>
        ...
        <form id="fm">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <label style="width: 130px">Bank Disbursement #</label>
                ...
                <div class="col-md-4">
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <label style="width: 130px">Bank Destination</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <label style="width: 130px">Acc Name Destination</label>
