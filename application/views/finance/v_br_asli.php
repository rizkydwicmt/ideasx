        ...
        <table id="dgMain" class="easyui-datagrid" style="width:100%;height:420px;;" url="<?= base_url(); ?>accfin/Payment/getPayment/<?= $notrans; ?>" singleSelect="true" rownumbers="true" pagination="true" toolbar="#toolbarFilter">
            <thead>
                <tr>
                    ...
                    <th field="no_payment" width="150">Bank Receipt #</th>
    ...
    <div id="dlg" class="easyui-panel" style="width:100%;height:500px;padding:10px;" data-options="iconCls:'icon-save',closable:true,
        ...
        <form id="fm">
            ...
            <div class="row">
                ...
                <!-- BEGIN col-4 -->
                <div class="col-md-4">
                    <label>Employee/Customer Name<span class="text-danger">*</span></label>
                    <Select id="kd_rekanan" name="kd_rekanan" class="form-control m-b-10 input-sm" required="true">
                        <option value="0">Select Employee/Customer</option>
                        <?php
                    ...
                    <label class="control-label">Account [Dr]<span class="text-danger">*</span></label>
                ...
                <div class="col-md-4">
                    <div class="row">
                        <div class="col-xs-6">
                            <label style="width: 130px">Cek/BG/TT #<span class="text-danger">*</span></label>
                            <input id="no_cek_bg_tt" name="no_cek_bg_tt" class="form-control m-b-10 input-sm" required="true" />
                        </div>
                        <div class="col-xs-6">
                            <label style="width: 130px">Bank Origin</label>
                            <input id="bank" name="bank" class="form-control m-b-10 input-sm" required="true" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-6">
                            <label style="width: 130px">Transaction type<span class="text-danger">*</span></label>
                            <Select id="jns_ttbg" name="jns_ttbg" class="form-control m-b-10 input-sm" required="true">
                                <option value="0">Select Trans type</option>
                                <option value="TT">TT</option>
                                <option value="CEK_BG">Cek/BG</option>
                                <option value="ATM">ATM</option>
                            </Select>
                        </div>
                        <div class="col-xs-6">
                            <label style="width: 130px">Acc Name Origin</label>
                            <input id="an" name="an" class="form-control m-b-10 input-sm" required="true" />
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function newData() {
        ...
        document.getElementById('jns_ttbg').value = '0';
        document.getElementById('bank').value = '';
        document.getElementById('no_cek_bg_tt').value = '';
    ...
    function editData() {
        ...
        if (row) {
            ...
            document.getElementById('an').value = row.an;
            document.getElementById('no_cek_bg_tt').value = row.no_cek_bg_tt;
            document.getElementById('bank').value = row.bank;
            document.getElementById('jns_ttbg').value = row.jns_ttbg;
    ...
    function saveDatax() {
        ...
        var an = $("#an").val();
        var no_cek_bg_tt = $("#no_cek_bg_tt").val();
        var bank = $("#bank").val();
        var jns_ttbg = $("#jns_ttbg").val();
