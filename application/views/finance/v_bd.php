        ...
        <table id="dgMain" class="easyui-datagrid" style="width:100%;height:420px;;" url="<?= base_url(); ?>accfin/Payment/getPayment/<?= $notrans; ?>" nowrap="false" fitColumns="true" singleSelect="true" rownumbers="true" pagination="true" toolbar="#toolbarFilter">
            <thead>
                <tr>
                    ...
                    <th field="no_payment" width="120">Bank Disbursement #</th>
                    <th field="dt_payment" width="80">Date</th>
                    <th field="nama_kasbank" width="100" align="left">Bank</th>
    ...
    function newData() {
        ...
        $.ajax({
            ...
            success: function(data) {
                window.open('<?= base_url(); ?>accfin/Payment/loadPayment/bd', '_self');
            }
        });
    }
